...
async function addFavorite(){
    ...
    if(response.ok){
        ...
        Logger.log("Favorited image!");
    } else {
        Logger.error("Favoriting image Failed!");
    }
}
...
async function removeFavorite(){
    ...
    if (response.ok) {
        Logger.log("Unfavorited image successfully");
    } else {
        Logger.error("Unfavoriting image failed");
    }
...
async function processBatch(posts, startIndex, page, recursionDepth) {
    ...
    if (fileUrl === undefined) {
        ...
        Logger.log(`[processBatch] SUCCESS - New Image Found! Score: ${post.score.total}, URL: ${fileUrl}, ID: ${fileId}, Favorited: ${isFavorited}`);
